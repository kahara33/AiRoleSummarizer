        ...
        <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
          ...
          <div className="flex-1 p-0 overflow-hidden flex flex-col">
            <TabsContent value={activeTab} className="m-0 flex-1">
              <ScrollArea className="agent-thoughts-scroll px-4 py-4 flex-1">
    ...
    <Card className="fixed right-4 top-20 h-[calc(100vh-120px)] flex flex-col z-50 shadow-lg w-96">
      ...
      <Tabs defaultValue="all" value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <CardContent className="flex-1 p-0 flex flex-col">
          <TabsContent value={activeTab} className="m-0 h-full flex-1 flex flex-col">
            <div className="flex-1 overflow-hidden">
              <ScrollArea className="agent-thoughts-scroll px-6 pb-4 h-full flex-1">
                {filteredThoughts.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-40">
